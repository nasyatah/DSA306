...
ggplot2_plot <- rplot(corr_plot)

# Modify the theme settings to adjust the x-axis labels
ggplot2_plot + theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
pipeline <- ml_pipeline(sc) |>
  ft_vector_assembler(
    input_cols = c("logistic_duration", "M_standardized", "F_standardized", "R_standardized"),
...
# Create a ggplot
ggplot(temp_df2, aes(x = factor(day_of_week, levels = 1:7, labels = day_names), y = number_of_transactions)) +
