...
library(ggplot2)
ref_customer |>
  select(-CustomerNo, -Duration, -month_with_max_spending) |>
...
tidy_glm_fit <- ref_customer_split_train |>
  ml_generalized_linear_regression(
    formula = logistic_duration ~ R_standardized + F_standardized + M_standardized + Average_basket_size + Unique_products + highest_month_spending + month_with_max_spending, family = "binomial"
  ) |>
  tidy() |>
  collect()
