...
validation_summary1$area_under_roc() #0.9355022

Model_1

#all the variables except avg_spend_per_trxcn
...
validation_summary2$area_under_roc() #0.9382239
...
#get the mean and sd values based on the whole dataset
...
#apply it to the whole data set
...
5.5 Deploy Kmeans model to production using Plumber
```{r}
library(plumber)
